...
//     constructor() public ERC721("VONDER NFT Generation II", "VNFTII") {
//         collectionName = name();
...
//     mapping(uint256 => address) public approvalOneVonderNFT; 
//     mapping(address => mapping(address => bool)) private _operatorApprovals;
...
//     address public _VNFT2;

//     constructor(address vnft2Address) public {

//         _VNFT2 = vnft2Address; // 0x003B5f941aC979dC8f41acdB3cCe59EF6aFAdF2d
...
//         uint256 _dadDna = _lotteryNFTdad.getLotteryNumbers(_dadId)[1]; // [a,b,c,d] a = gender, b = initialGene, c = dominantGene, d = recessiveGene
//         uint256 _dadGeneration = 1;
//         uint256 _mumDna = _lotteryNFTmum.getLotteryNumbers(_mumId)[1];
//         uint256 _mumGeneration = 1;
...
//         ILottery _lotteryNFTmum,
//         uint256 _mumId,
//         ILottery _lotteryNFTdad,
//         uint256 _dadId,
//         uint256 _generation,
//         uint256 _genes,
//         address _owner
...
//         uint256 newBornTokenId = IVNFT2(_VNFT2).mintCryptoNFTs(
//             "UNDEAD II",
//             "",
//             0
//         );
//         IVNFT2(_VNFT2).safeTransferFrom(address(this), _owner, newBornTokenId);

//         _lotteryNFTmum.safeTransferFrom(_owner, address(this), _mumId);
//         _lotteryNFTdad.safeTransferFrom(_owner, address(this), _dadId);

//         // _lotteryNFTmum.burn(_mumId);
//         // _lotteryNFTdad.burn(_dadId);
//         emit Birth(_owner, newBornTokenId, _mumId, _dadId, _genes);
//         return newVonderNFTId;
//     }

//     function theMint() public {
//         IVNFT2(_VNFT2).mintCryptoNFTs("UNDEAD II", "", 0);
//     }

//     function burn(uint256 _tokenId) public {
//         // Burn Gen2
//         require(VonderNFTOwner[_tokenId] == msg.sender);
...
//     function getAllVonderNFTsOfOwner(address owner)
//         external
//         view
//         returns (uint256[] memory)
//     {
//         uint256[] memory allVonderNFTsOfOwner = new uint256[](
//             ownsNumberOfTokens[owner]
//         );
//         uint256 j = 0;
