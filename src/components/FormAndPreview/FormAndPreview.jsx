...
class FormAndPreview extends Component {
  ...
  callMintMyNFTFromApp = (e) => {
    ...
    this.props.mintMyNFT(
      ...
      this.state.cryptoNFTsName,
      this.state.cryptoNFTsPrice
    );
  };
      ...
      <div>
        <div className="card mt-1">
          <div className="card-body align-items-center d-flex justify-content-center">
            <h5>Color Your Crypto NFTs As You Want It To be!</h5>
          </div>
        </div>
        <form onSubmit={this.callMintMyNFTFromApp} className="pt-4 mt-1">
          <div className="row">
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center">
              <CryptoNFTsNFTImage colors={this.state.userSelectedColors[0]} />
            </div>
          </div>
          <div className="row">
            <div className="col-md-3">
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="cryptoNFTsName">Name</label>
                <input
                  required
                  type="text"
                  value={this.state.cryptoNFTsName}
                  className="form-control"
                  placeholder="Enter Your Crypto NFTs's Name"
                  onChange={(e) =>
                    this.setState({ cryptoNFTsName: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  name="price"
                  id="cryptoNFTsPrice"
                  value={this.state.cryptoNFTsPrice}
                  className="form-control"
                  placeholder="Enter Price In Ξ"
                  onChange={(e) =>
                    this.setState({ cryptoNFTsPrice: e.target.value })
                  }
                />
              </div>
              <button
